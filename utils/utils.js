(function () {
  ...
  module.exports = {
    ...
    /**
     * transform user input into folder for the FS
     * @param  {String} userInput arbitrary user input
     * @return {String}           FS-friendly module name
     */
    moduleFolder: function (userInput) {
      var moduleFolder = userInput.replace(/\./g, '/');
      return strings.camelToSnake(moduleFolder);
    },
