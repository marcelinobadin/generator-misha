(function () {
  ...
  describe('utils', function () {
    ...
    it('.controllerName()', function () {
      assert.textEqual(utils.controllerName('lower'), 'Lower' + config.CONTROLLER_SUFFIX);
      assert.textEqual(utils.controllerName('Upper'), 'Upper' + config.CONTROLLER_SUFFIX);
      assert.textEqual(utils.controllerName('lowerCamel'), 'LowerCamel' + config.CONTROLLER_SUFFIX);
      assert.textEqual(utils.controllerName('UpperCamel'), 'UpperCamel' + config.CONTROLLER_SUFFIX);
