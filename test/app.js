...
// local modules
  ...
  describe('misha:app', function () {
    ...
    describe('sampleAnswers (--skip-install)', function () {
      ...
      it('creates module named base', function () {
        assert.file([
          'app/base',
          'app/base/base.js',
      ...
      it('version injected in README.md', function () {
        ...
        assert.fileContent('README.md', 'This project was generated with Generator-Misha v' + pkg.version + '. For more info visit the [repository](https://github.com/marcelinobadin/generator-misha) or check out the README below.');
        assert.fileContent('README.md', '# Generator-Misha v' + pkg.version);
      });
    ...
    describe('ionicCss', function () {
      ...
      it('includes ionic css', function () {
        assert.noFileContent('app/base/main/styles/main.scss', '$light');
    ...
    describe('ionicSass', function () {
      ...
      it('includes ionicSass', function () {
        assert.fileContent('app/base/main/styles/main.scss', '$light');
        assert.fileContent('gulp/injecting.js', '.pipe(wiredep.stream({exclude: [\'bower_components/ionic/release/css\']}))');
        assert.fileContent('gulp/injecting.js', 'var DEST = \'app/base/main/assets/fonts\'');
      });
    });
